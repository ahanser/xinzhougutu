  ...
  <div class="system">
                ...
                <section>
                  <el-form :model="formInline">
                    <el-form-item label="名称：">
                      <el-input style="width:80%;border:none" v-model="formInline.layername"></el-input>
                    </el-form-item>
                    <el-form-item label="wfsUrl:">
                      <el-input style="width:80%;border:none" v-model="formInline.wfsUrl"></el-input>
                    </el-form-item>
                    <el-form-item label="wmsUrl:">
                      <el-input style="width:70%;border:none" v-model="formInline.wmsUrl"></el-input>
                    </el-form-item>
                  </el-form>
                </section>
                <footer>
    ...
    >
      <el-form :model="addformInline" class="demo-form-inline" label-width="100px">
        ...
        <el-form-item label="wmsUrl:">
          <el-input v-model="addformInline.wmsUrl" placeholder="请输入wmsUrl名称"></el-input>
        </el-form-item>
        <el-form-item label="wfsUrl:">
          <el-input v-model="addformInline.wfsUrl" placeholder="请输入wfsUrl名称"></el-input>
        </el-form-item>
        <el-form-item label="上级目录:" v-show="addformInline.level=='2'?true:false">
          <treeselect
            v-model="addformInline.up"
            :multiple="false"
            :options="options"
            placeholder="请选择"
          />
...
export default {
  ...
  methods: {
    getTreeData() {
      let that = this
      this.$service.get(url.getsettree).then(function(res) {
    ...
    nodeClick(data) {
      ...
      this.folderName = data.layername
      this.show = true
        ...
        this.$service
          .post(
            ...
            qs.stringify({
              ...
              wmsUrl: this.addformInline.wmsUrl,
              wfsUrl: this.addformInline.wfsUrl
            })
          )
          .then(function(res) {
            console.log(res)
    ...
    deleteNode() {
      ...
      this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
        ...
        .then(() => {
          this.$service
            .get(url.deletesetfrom + this.deleteNodeId)
            .then(function(res) {
              that.show = false
              that.getTreeData()
              that.$message({
      ...
      this.$service
        .post(
          ...
          qs.stringify({
            ...
            name: this.formInline.layername,
            wmsUrl: this.formInline.wmsUrl,
            wfsUrl: this.formInline.wfsUrl
          })
        )
        .then(function(res) {
          that.$message({
          ...
          that.folderName = that.formInline.layername
        })
    }, //更新节点
    clearfrominfo() {
      this.addformInline = {
